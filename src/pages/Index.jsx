        ...
        <Card className="mb-8">
          ...
          <CardContent>
            <p>
              ...
              companionship, and diverse breeds. They have been living alongside humans for thousands of years, 
              serving various roles from working animals to beloved pets.
            </p>
          </CardContent>
        </Card>
          ...
          <Card>
            ...
            <CardContent>
              <ul className="list-disc pl-5">
                ...
                <li>Varied sizes and appearances</li>
